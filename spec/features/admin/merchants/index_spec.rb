...
RSpec.describe "Admin Merchants Index", type: :feature do
  describe "when I visit /admin/merchants" do
    ...
    it "I see the date that each top 5 merchant had their best day of total_revenue" do
      ...
      merchant_2 = Merchant.create!(name: "Ray's Handmade Jewelry")
      merchant_3 = Merchant.create!(name: "Susy's Sweets")
      merchant_4 = Merchant.create!(name: "Real Leather Purses")
      merchant_5 = Merchant.create!(name: "Abby's Apples")
      ...
      invoice_item_7 = create(:invoice_item, quantity: 4, unit_price: 79285, item: item_for_merchant_4, invoice: invoice_7)
      invoice_item_8 = create(:invoice_item, quantity: 9, unit_price: 34925, item: item_for_merchant_4, invoice: invoice_8)
      invoice_item_9 = create(:invoice_item, quantity: 6, unit_price: 90823, item: item_for_merchant_5, invoice: invoice_9)
      invoice_item_10 = create(:invoice_item, quantity: 10, unit_price: 86347, item: item_for_merchant_5, invoice: invoice_10)
